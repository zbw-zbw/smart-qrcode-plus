...
function App() {
  ...
  const [decodeResult, setDecodeResult] = useState<DecodeResultType | null>(
    null
  );
  ...
  return (
    <div className="w-96 bg-white">
      ...
      {mode === 'generate' && (
        <>
          <div className="p-4">
            <URLInput url={currentUrl} onChange={handleUrlChange} />
          </div>

          <div className="p-4 border-t border-gray-200">
            <URLParamsEditor params={params} onChange={handleParamsChange} />
          </div>
